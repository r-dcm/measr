...
- Some of measr’s functionality has been decoupled into other packages
  ...
  [`measr_dcm()`](https://measr.r-dcm.org/reference/measr_dcm.md) has
...
- [`predict()`](https://rdrr.io/r/stats/predict.html) has been
  ...
  [`score()`](https://measr.r-dcm.org/reference/score.md). The
  functionality is the same, but

### New features

- [`aic()`](https://measr.r-dcm.org/reference/aic-bic.md) and
  [`bic()`](https://measr.r-dcm.org/reference/aic-bic.md) have been
...
- Item and attribute discrimination measures can now be calculated with
  [`cdi()`](https://measr.r-dcm.org/reference/cdi.md)
...
- New estimation methods,
  [`variational()`](https://measr.r-dcm.org/reference/stan-classes.md)
  and
  [`pathfinder()`](https://measr.r-dcm.org/reference/stan-classes.md),
...
- Support for additional model specifications has been added
  ...
  - The compensatory reparameterized unified model (C-RUM) can now be
    ...
    [`measr_dcm()`](https://measr.r-dcm.org/reference/measr_dcm.md)
    function.
