...
- `ppmc_raw_score`: The observed and posterior predicted chi-square
  ...
  [`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md) for
  details.
...
- `aic`: The Akaike information criterion results. See
  [`aic()`](https://measr.r-dcm.org/reference/aic-bic.md) for details.

- `bic`: The Bayesian information criterion results. See
  [`bic()`](https://measr.r-dcm.org/reference/aic-bic.md) for details.
