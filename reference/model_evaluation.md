...
- save:
  ...
  [measrdcm](https://measr.r-dcm.org/reference/dcm_estimate.md) object
...
A modified [measrdcm](https://measr.r-dcm.org/reference/dcm_estimate.md)
...
[`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md) to
...
[`log_mll()`](https://measr.r-dcm.org/reference/log_mll.md) to calculate
...
[`aic()`](https://measr.r-dcm.org/reference/aic-bic.md) or
[`bic()`](https://measr.r-dcm.org/reference/aic-bic.md) to estimate the
