...
To install the development version of measr from [GitHub](https://github.com/r-dcm/measr) use:
...
Once a model has been estimated, model parameters, respondent classifications, and results of the model fit analyses can then be extracted using `measr_extract()`.
...
To ensure a smooth process, please review the [Contributing Guide](https://measr.r-dcm.org/CONTRIBUTING.html).
Please note that the measr project is released with a [Contributor Code of Conduct](https://measr.r-dcm.org/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
