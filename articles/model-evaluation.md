...
functionality](https://measr.r-dcm.org/articles/model-estimation.md).
...
models](https://measr.r-dcm.org/articles/model-estimation.md).
...
[`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md). Using
[`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md) can
...
[`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md) returns a
...
using [`fit_ppmc()`](https://measr.r-dcm.org/reference/fit_ppmc.md).
