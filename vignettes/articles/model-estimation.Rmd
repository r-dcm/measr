...
param_compare <- item_parameters |>
  left_join(
    sim_data$true_items,
    by = c("item_id", "type" = "class", "attributes", "coefficient" = "coef"),
...
strc_compare <- measr_extract(lcdm, "strc_param") |>
  left_join(true_strc, join_by(class == label), relationship = "one-to-one") |>
...
If there is a specific subtype you are interested in, or would like to see supported, please open an issue on the [GitHub repository](https://github.com/r-dcm/measr/issues).
